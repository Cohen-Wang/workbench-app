<template>
	<view class="uni-searchbar">
      ...
      <text class="lg text-gray cuIcon-search" style="margin:0 10px"></text>
			<!-- #endif -->
			...
			<text v-else class="uni-searchbar__text-placeholder" style="">{{ placeholder }}</text>
			<view v-if="show && (clearButton==='always'||clearButton==='auto'&&searchVal!=='')" class="uni-searchbar__box-icon-clear" @click="clear">
        <text class="lg text-gray cuIcon-roundclosefill" style="margin:0 10px;font-size:16px"></text>
